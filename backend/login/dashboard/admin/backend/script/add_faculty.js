    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        section.innerHTML =
          ...
          ' <br /> Email: ' +
          data[i].email +
          '<br /> </p> <ul class="social-icon mt-4"> <li class="social-icon-item"> <a href="'+ data[i].site +'" class="social-icon-link bi-globe"></a> </li> <li class="social-icon-item"> <a href="#" class="social-icon-link bi-facebook"></a> </li> <li class="social-icon-item"> <a href="#" class="social-icon-link bi-instagram"></a> </li> <li class="social-icon-item"> <a href="javascript:delList(' +
          data[i].id +
  ...
  xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      window.location.href =
        '../../../../../../backend/login/dashboard/admin/faculty.html';
    }
  };
  xhttp.open(
    'GET',
    '../../../../../../backend/login/dashboard/admin/backend/script/del_faculty.php?id=' +
      id,
    true
  );
  xhttp.send();
